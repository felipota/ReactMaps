...
let toMiles = (meters) => meters * 0.001;
    ...
    renderDistance(distance = 0) {
        return (
            <div className="distance">
                <h2><i className="icon-directions_car"/> Distancia</h2>
                <p className="value">{distance > 0 ? (toMiles(distance).toFixed(2)) : 0}</p>
                <p className="unit">{distance <= 1 ? 'Kilometros' : 'Kilometro'}</p>
            </div>
        )
    }
    ...
    renderDuration(duration = 0) {
        ...
        return (
            <div className="duration">
                <h2><i className="icon-clock"/> Duracion</h2>
                <ul>
                    {elm}
                    {dayElm}
                    {hourElm}
