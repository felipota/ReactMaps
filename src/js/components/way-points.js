    ...
    renderWayPoints() {
        ...
        return (
            <ul className={cx}>
                ...
                <li className="add-place"><i className="icon-flag"/> <Link onClick={this.props.onAdd.bind(this, 0)}>Agregar Direccion
                   </Link></li>
            </ul>
        )
    }
    ...
    renderEmptyWayPoints() {
        return (
            <ul className="way-points empty">
                <li><i className="icon-flag"/> <Link onClick={this.props.onAdd.bind(this, 0)}>Agregar Direccion</Link></li>
            </ul>
        )
    }
